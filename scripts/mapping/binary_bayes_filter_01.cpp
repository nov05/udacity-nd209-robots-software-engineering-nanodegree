...
int main()
{
    ...
    // Verify the map
    // resultFile = "binary_bayes_filter_01_result.txt";
    resultFile = "D:/github/udacity-nd209-robots-software-engineering-nanodegree/scripts/mapping/binary_bayes_filter_01_result.txt";
    verify(resultFile, l);
